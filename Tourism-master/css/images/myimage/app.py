...
def login():
    msg = ''
    # if the metod is post post what you get in the database
...
#   register by using a mathod get and post
@app.route('/register', methods =['GET', 'POST'])
def register():
    msg = ''
    # if the mathod is post set the value in the display page
    if request.method == 'POST' and 'username' in request.form and 'password' in request.form and 'email' in request.form and 'address' in request.form and 'city' in request.form and 'country' in request.form and 'postalcode' in request.form and 'organisation' in request.form:
        ...
        account = cursor.fetchone()
        # if the person have olrady an account display Account already exists 
        if account:
            msg = 'Account already exists !'
        # if the email is not correct display Invalid email address !     
